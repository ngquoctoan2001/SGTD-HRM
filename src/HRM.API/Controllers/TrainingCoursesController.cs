...
public class TrainingCoursesController : ControllerBase
{
    ...
    public TrainingCoursesController(ITrainingCourseService service) => _service = service;
    ...
    public async Task<IActionResult> Create([FromBody] CreateTrainingCourseDto dto)
    {
    ...
    [HttpPut("{id}")]
    [Authorize(Roles = "Admin,HR")]
    public async Task<IActionResult> Update(int id, [FromBody] CreateTrainingCourseDto dto)
    {
